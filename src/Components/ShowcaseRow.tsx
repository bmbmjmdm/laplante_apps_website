...
export const ShowcaseRow:FunctionComponent<ShowcaseRowProps> = ({ 
  ...
  const imageWidth = customImageDimensions ? customImageDimensions.width :
                     horizontalImage ? theme.showcaseImageLong :
  ...
  const buttons = (
    <Flex row style={{marginTop: "auto"}}>
      {apple &&
        <ShowcaseButton link={apple} name={"Apple"} singleColumn={singleColumn} />
      }
      {android && 
        <ShowcaseButton link={android} name={"Android"} singleColumn={singleColumn} />
      }
      {link && 
