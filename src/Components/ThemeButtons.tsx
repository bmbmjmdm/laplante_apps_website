...
export const ThemeButtons:FunctionComponent<{}> = () => {
  ...
  const [floatingTextThree, setFloatingTextThree] = React.useState<FloatingTextObj>({})
...
const addFloatingText = (setFloatingText: React.Dispatch<React.SetStateAction<FloatingTextObj>>, text: string, delay = 0) => {
  setTimeout(() => {
      ...
      textCopy[id] = (
        <Animated.View
          ...
          style={{
            ...
            width: themeContainer?.navButton.width + (2 * themeContainer?.navButton.marginLeft),
            alignItems: "center"
          }}>
